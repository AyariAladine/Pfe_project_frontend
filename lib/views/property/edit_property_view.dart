...
class _EditPropertyViewState extends State<EditPropertyView> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider.value(
      value: _viewModel,
      child: _EditPropertyViewContent(property: widget.property),
    );
  }
}

class _EditPropertyViewContent extends StatelessWidget {
  final PropertyModel property;

  const _EditPropertyViewContent({required this.property});
                  ...
                  children: [
                    Expanded(
                      child: OutlinedButton.icon(
                        onPressed: () =>
                            _showMapPicker(context, viewModel, isDark),
                  ...
                  onPressed: viewModel.hasChanges && !viewModel.isLoading
                      ? () async {
                          ...
                          if (success && context.mounted) {
                            ...
                            Navigator.pop(context, viewModel.updatedProperty);
                          }
                        }
                      : null,
                ),
  ...
  Widget _buildImageSection(
    ...
    _EditPropertyViewModel viewModel,
    bool isDark,
  ) {
    return Container(
      decoration: BoxDecoration(
        ...
        children: [
          ...
          ClipRRect(
            ...
            child: SizedBox(
              ...
              child: _buildImagePreview(viewModel, isDark),
            ),
          ),
          // Image actions
          Padding(
            ...
            child: Row(
              children: [
                ...
                if (viewModel.newImage != null || viewModel.imageUrl != null)
                  IconButton(
  ...
  Widget _buildImagePreview(_EditPropertyViewModel viewModel, bool isDark) {
    if (viewModel.newImage != null) {
      return Image.file(viewModel.newImage!, fit: BoxFit.cover);
    } else if (viewModel.imageUrl != null && viewModel.imageUrl!.isNotEmpty) {
      return NetworkImageWithAuth(
      ...
      children: [
        Expanded(
          child: _buildTypeCard(
            ...
            isSelected: viewModel.selectedPropertyType == PropertyType.rent,
            isDark: isDark,
        ...
        Expanded(
          child: _buildTypeCard(
            ...
            isSelected: viewModel.selectedPropertyType == PropertyType.sale,
            isDark: isDark,
  ...
  Widget _buildDocumentSection(
    ...
    if (viewModel.newDocument != null) {
      return _buildDocumentPreview(viewModel, isDark, isNew: true);
    } else if (viewModel.documentUrl != null &&
        viewModel.documentUrl!.isNotEmpty) {
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  isNew ? 'New document selected' : 'Document uploaded',
          ...
          Row(
            ...
            children: [
              ...
              IconButton(
                ...
                onPressed: viewModel.removeDocument,
              ),
            ],
          ),
        ],
  ...
  void _showMapPicker(
    ...
    showModalBottomSheet(
      ...
      backgroundColor: Colors.transparent,
      builder: (context) =>
          _MapPickerSheet(viewModel: viewModel, isDark: isDark),
    );
  }
...
class _EditPropertyViewModel extends ChangeNotifier {
  ...
  File? get newDocument => _newDocument;
  ...
  Future<bool> saveChanges() async {
    ...
    try {
      ...
      // Handle image upload (in production, upload to server first)
      if (_imageRemoved) {
        updates['propertyimage'] = null;
      } else if (_newImage != null) {
        // TODO: Upload image and get URL
        // updates['propertyimage'] = uploadedImageUrl;
      }

      // Handle document upload (in production, upload to server first)
      if (_documentRemoved) {
        updates['Registrationdocument'] = null;
      } else if (_newDocument != null) {
        // TODO: Upload document and get URL
        // updates['Registrationdocument'] = uploadedDocUrl;
      }
      ...
      _updatedProperty = await _propertyService.updateProperty(
